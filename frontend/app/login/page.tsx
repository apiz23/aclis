...
export default function Login() {
  ...
  return (
    <div className="relative min-h-dvh flex items-center justify-center overflow-hidden bg-primary">

      {/* ── SVG background ── */}
      <svg
        aria-hidden
        className="absolute inset-0 h-full w-full pointer-events-none select-none text-primary-foreground"
      ...
      <div className="relative z-10 w-full max-w-sm mx-4 animate-in fade-in-0 slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col items-center gap-3 mb-7">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-foreground/15 border border-primary-foreground/25 backdrop-blur-sm shadow-lg">
          ...
          <div className="text-center">
            <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-primary-foreground/50 mb-1">
              Pejabat Daerah Pontian
            </p>
            <h1 className="font-heading text-3xl font-bold tracking-tight text-primary-foreground">ACLIS</h1>
            <p className="text-sm text-primary-foreground/60 mt-1">Log masuk ke akaun anda</p>
          </div>
        </div>

        {/* Card */}
        <div className="rounded-2xl bg-background/95 backdrop-blur-md shadow-2xl border border-white/10 p-7">
        ...
        {/* Footer */}
        <p className="text-center text-[10px] text-primary-foreground/35 mt-5 tracking-wide">
